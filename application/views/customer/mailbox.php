        ...
        <div class="row">
                    ...
                    <div class="ibox-content mailbox-content">
                        <div class="file-manager">
                            ...
                            <ul class="folder-list m-b-md" style="padding: 0">
                                <li><a href="/mailbox"> <i class="fa fa-inbox "></i> Inbox <span class="label label-warning pull-right">1</span> </a></li>
            ...
            <div class="mail-box-header">
                ...
                <tr class="unread">
                    ...
                    <td class="mail-ontact"><a href="mail_detail.html">panjie</a></td>
                    <td class="mail-subject"><a href="mail_detail.html">fitpa message</a></td>
